...
const ContactUs = () => {
  ...
  return (
    ...
    <div className="bg-gradient-to-br from-blue-50 to-blue-50 min-h-screen">
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          >
            <div className="flex items-center mb-6">
              <FaPaperPlane className="text-blue-500 mr-4 text-3xl" />
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                type="submit"
                className="w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white py-4 rounded-xl font-semibold hover:from-blue-600 hover:to-purple-700 transition-all duration-300 shadow-lg"
              >
                Send Message
              </motion.button>
            </form>
          ...
          >
            <div>
              <div className="flex items-center mb-6">
                <FaMapMarkerAlt className="text-blue-500 mr-4 text-3xl" />
